...
function App({ horoscope }: Props) {
  ...
  return <Grid display={'flex'} direction={'column'} alignItems={'center'}>
    <Head>
      ...
      <meta property="twitter:image" content="https://cdn4.telegram-cdn.org/file/oqgZ0lO6-pQzCqb0BAI9qMmk3oyfGGiNfwEm2l6stDqgXgfDsY0il6C_il2kAdktFj3ImPxMRA90jU7wqFCMp-5F5-hXDim9YD6s-DQmNqUdR8DS2fk5aLDvhtypjVl7j96x901Z3lpBx_xoZzFvFD032_C-C81f9IA2WDxyUCMAPJL5cS8UNMPCInPUW1TIJlzPFBDULi4VN0xalNpsWdETWsev6UBvpYuFi6metGwHYe4LYN0-4B9eb0AM7E598pa-aGVxIw-qZVkveQQv6SMp-tVM-HWsTavGEOtyDz1MBDSAzO98qDPwLqKXecwZoReWqAt7u0N3AUIQMbaHxg.jpg" />
...
App.getInitialProps = async (context: any) => {
  const horoscope = parseHoroscopeUrl(context.router.asPath);
